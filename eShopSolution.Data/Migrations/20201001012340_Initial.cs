        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducCategoryIds = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoDesciption = table.Column<string>(maxLength: 255, nullable: true),
                    SeoTile = table.Column<string>(maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategotyTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategotyTranslations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategotyTranslations_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeoDescription = table.Column<string>(maxLength: 50, nullable: true),
                    SeoTile = table.Column<string>(maxLength: 50, nullable: true),
                    ProductId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategotyTranslations_CategoryId",
                table: "CategotyTranslations",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategotyTranslations_LanguageId",
                table: "CategotyTranslations",
                column: "LanguageId");
